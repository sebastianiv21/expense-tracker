      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Welcome back! Here&apos;s your financial summary for{" "}
        ...
        <Card className="lg:col-span-4">
          <CardHeader className="flex flex-row items-center justify-between p-4 sm:p-6">
            <div className="space-y-0.5 min-w-0">
              ...
              <CardDescription className="truncate">Your last activities</CardDescription>
            </div>
            <Link href="/transactions" className="shrink-0">
              <Button variant="ghost" size="sm" className="gap-1 px-2 h-8 sm:h-9">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm gap-2">
                ...
                <span className="font-medium shrink-0">
                  ...
                  {allocation?.targets.needs.toFixed(0)}
                </span>
              </div>
              <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(100, ((allocation?.actual.needs || 0) / (allocation?.targets.needs || 1)) * 100)}%`,
                  }}
                />
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between text-sm gap-2">
                ...
                <span className="font-medium shrink-0">
                  ...
                  {allocation?.targets.wants.toFixed(0)}
                </span>
              </div>
              <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(100, ((allocation?.actual.wants || 0) / (allocation?.targets.wants || 1)) * 100)}%`,
                  }}
                />
              </div>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between text-sm gap-2">
                ...
                <span className="font-medium shrink-0">
                  ...
                  {allocation?.targets.future.toFixed(0)}
                </span>
              </div>
              <div className="h-2 w-full bg-muted rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${Math.min(100, ((allocation?.actual.future || 0) / (allocation?.targets.future || 1)) * 100)}%`,
                  }}
                />
              </div>
            </div>
